...
import com.example.presentzadmin.adapter.CategoryAdapter
import com.example.presentzadmin.databinding.FragmentCategoryBinding
    ...
    private fun storeData(categoryName: String, url: String) {
        ...
        db.collection("categories").add(data)
            .addOnSuccessListener {
                ...
                binding.imageView.setImageDrawable(resources.getDrawable(R.drawable.place_holder))
                getData()
